/*
MySQL Backup
Database: nest-admin-prisma
Backup Time: 2024-05-18 10:42:47
*/

SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS `nest-admin-prisma`.`_prisma_migrations`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`_sys_dept_to_sys_role`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`_sys_menu_to_sys_role`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`_sys_post_to_sys_user`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`_sys_role_to_sys_user`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_config`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_dept`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_dict_data`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_dict_type`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_job`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_job_log`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_login_infor`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_menu`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_notice`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_oper_log`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_post`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_role`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_table`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_user`;
DROP TABLE IF EXISTS `nest-admin-prisma`.`sys_web`;
